...
class Hospital {
    ...
    public static String[] addPatientsDetails(@NonNull String[] input, @NonNegative int n, @NonNull String detailsToBeAdded) {
    ...
    public static String[] removePatientsDetails(@NonNull String[] input, @NonNegative int n, @NonNull String patientIdToRemove) {
        //Write your code here
    ...
    public static String[] updatePatientsDetails(@NonNull String[] input, @NonNegative int n, @NonNull String patientIdToUpdate,
